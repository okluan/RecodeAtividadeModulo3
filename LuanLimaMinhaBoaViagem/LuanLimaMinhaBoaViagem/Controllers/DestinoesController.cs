...
namespace LuanLimaMinhaBoaViagem.Controllers
{
    public class DestinoesController : Controller
    {
        ...
        public DestinoesController(AppDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DestinoId,CPF,Cidade,UF,Valor,Hotel,Embarque,Desembarque,Parcelas,Pessoas")] Destino destino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DestinoId,CPF,Cidade,UF,Valor,Hotel,Embarque,Desembarque,Parcelas,Pessoas")] Destino destino)
        {
