...
namespace LuanLimaMinhaBoaViagem.Controllers
{
    public class ContatoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,Logradouro,Bairro,Cidade,UF,Nascimento")] Contato contato)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,Logradouro,Bairro,Cidade,UF,Nascimento")] Contato contato)
        {
            if (id != contato.Id)
            {
                return NotFound();
